...
const encryptionKeyWords = NODE_ENV === 'production' ? ENCRYPTION_KEY_WORDS : ENCRYPTION_KEY_WORDS_LOCAL;
const encryptedFile = NODE_ENV === 'production' ? 'encrypted-prod.json' : 'encrypted-dev.json';
...
fs.writeFile('encrypted.js', `module.exports = { encrypted: "${encryptDatas}" };`, err => {
